	...
	<div class="container">
        ...
        <form action="UpdateInfo" method="post" >
			...
			<div class="form-group">
			    ...
			    <input type="tel" id="phone" name="phone" value="<%= request.getAttribute("soDienThoai")%>" required>
			</div>
			<div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea id="address" name="address" value="<%= request.getAttribute("diaChi") %>" required></textarea>
            </div>
            <div class="form-group">
