        ...
        <body>
            <div class="container emp-profile">
                ...
                <c:if test="${acc.role == 'giasu'}">
                    ...
                    <hr>
                    <a href="${ pageContext.request.contextPath }/managerLopHoc?action=create" type="button"
                ...
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab"
                            href="${ pageContext.request.contextPath }/managerLopHoc?lever=1">Tiểu Học</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab"
                            href="${ pageContext.request.contextPath }/managerLopHoc?lever=2">Trung Học</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab"
                            href="${ pageContext.request.contextPath }/managerLopHoc?lever=3">Trung Học Phổ Thông</a>
                    </li>
                </ul>
