...
<head>
    ...
    <link rel="stylesheet" href="css/dashboard/styleDashboardTutor.css">
    <link rel="stylesheet"
...
<div class="khoiben">
    ...
    <div class="menu-khoiben">
        ...
        <ul>
            ...
            <li class="gia-su">
                <a href="/Web_Tutor/giasu" class="a-gia-su activate">
...
<script src="dashboardjs/dashboard-tutor.js"></script>
