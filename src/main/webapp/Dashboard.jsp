...
<html>
  ...
  <body>
    ...
    <div class="khoiben">
      ...
      <div class="menu-khoiben">
        <div class="khoiben-user">
          ...
          <div class="user"><small>Software Developer</small> <p>Tuan Anh</p> </div>
        </div>
        <ul>
          <li>
            <a href="" class="activate">
              <span class="las la-home-scale"></span>
              <span>Dashboard</span>
            </a>
          </li>
          <li>
        ...
        <div class="nhieuthe">
          <div class="the">
            ...
            <div class="thongtin-the">
              <h2 class="total-branch">0</h2>
              <small>Chi nhánh</small>
            </div>
            <!-- <div class="anh-the">
                        <div style="background-image: url(/src/main/webapp/anhthe1.png);"></div>
                        <div style="background-image: url(/src/main/webapp/anhthe1.png);"></div>
                        <div style="background-image: url(/src/main/webapp/anhthe1.png);"></div>
                        <div style="background-image: url(/src/main/webapp/anhthe1.png);"></div>
                        <div style="background-image: url(/src/main/webapp/anhthe1.png);"></div>
          ...
          <div class="the">
            <div class="icon-the comments">
              <span class="las la-comment"></span>
            </div>
            <div class="thongtin-the">
              <h2>661</h2>
              <small
                >Điện thoại được bán bởi Lê Tuấn Anh trong ngày
                20/01/2023</small
              >
            </div>
            <!-- <div class="anh-the">
          ...
          <div class="the">
            ...
            <div class="thongtin-the">
              <h2>19,855</h2>
              <small
                >Số nhân viên thuộc chi nhánh Hà Nội tham gia bán hàng vào ngày
                20/01/2023</small
              >
            </div>
            <!-- <div class="anh-the">
    ...
    <script src="/src/main/webapp/js/dashboard.js"></script>
  </body>
</html>