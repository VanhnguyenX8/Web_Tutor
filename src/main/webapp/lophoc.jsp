...
<head>
  ...
  <link rel="stylesheet" href="./css/styleLopHoc.css">
  <link rel="stylesheet"
...
<div class="khoiben">
  ...
  <div class="menu-khoiben">
    ...
    <ul>
      ...
      <li class="lop-hoc">
        <a href="http://localhost:8080/DashBoardWeb_war_exploded/lophoc" class="a-lop-hoc activate">
    ...
    <div class="table">
      <div class="sub_table">
        <div class="row-header">
          ...
          <div class="cell_header">Image</div>
