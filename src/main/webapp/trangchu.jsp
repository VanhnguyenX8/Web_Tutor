...
<html>
  ...
  <body>
    ...
    <div id="toanbotrang">
      ...
      <!-- Trung học phổ thông -->
      <p style="padding-left: 60px">Trung học phổ thông</p>
        ...
        <tr>
          <th colspan="2">
            <div>
              <img
                class="images_thpt"
                src="../assets/images/img_thpt/1.banner.png"
                alt=""
              />
            </div>
          </th>
      ...
      <p style="padding-left: 60px">Trung học cơ sở</p>
      <table class="table_thpt" style="margin-top: 20px" border="0">
        <tr>
          <th colspan="2">
            <div>
      ...
      <!-- tiểu học -->
      <div style="height: 60px"></div>
      <p style="padding-left: 60px">Tiểu học</p>
      <table class="table_thpt" style="margin-top: 20px" border="0">
        <tr>
          <th colspan="2">
            <div>
            ...
            <div class="footer-block">
              ...
              <a href=""
                ><img
                  ...
                  src="../assets/images/footer-google-app.png"
              /></a>
              <a href=""
                ><img
                  class="footer-img-app"
                  src="../assets/images/footer-store-app.png"
              /></a>
              <a href=""
                ><img
                  class="footer-img-app"
                  src="../assets/images/congthuong.png"
              /></a>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            <div class="row-left">
              <p>
                ...
                ngày 13 tháng 03 năm 2007 <br />
                Địa chỉ: <br />
                - Văn phòng Hà Nội: Tầng 4, Tòa nhà 25T2, Đường Nguyễn Thị Thập,
                Phường Trung Hoà, Quận Cầu Giấy, Hà Nội. <br />
                - Văn phòng TP.HCM: 13M đường số 14 khu đô thị Miếu Nổi, Phường
                3, Quận Bình Thạnh, TP. Hồ Chí Minh <br />
