...
<head>
    ...
    <link rel="stylesheet" href="./css/styleGiasu.css">
    <link rel="stylesheet"
...
<div class="khoiben">
    ...
    <div class="menu-khoiben">
        ...
        <ul>
            ...
            <li class="gia-su">
                <a href="http://localhost:8080/DashBoardWeb_war_exploded/giasu" class="a-gia-su activate">
                    <span class="las la-users"></span>
                    <span>Gia Sư</span>
                </a>
            </li>
            <li class="hoc-sinh">
                <a href="http://localhost:8080/DashBoardWeb_war_exploded/hocsinh" class="a-hoc-sinh">
                    <span class="las la-users"></span>
                    <span>Học Sinh</span>
                </a>
            </li>
        ...
        <div class="table">
            <div class="sub_table">
                <div class="row-header">
                    ...
                    <div class="cell_header">Payment Amount</div>
