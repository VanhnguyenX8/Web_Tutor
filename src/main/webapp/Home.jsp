...
<body>
                ...
                <img class="anhiconlogo" src="logo." alt="">
          		<div class="thongtinnguoidung">
            		...
            		<button class="subdangki" type="submit">
              			<a href="/Web_Tutor/SignUpServlet">Đăng Kí</a>
            		</button>
          		</div>
            </div>
        </div>
    ...
    <table class="table_thpt" style="margin-top: 20px;" border="0">
        <tr>
            <th colspan="2"><div><img class="images_thpt" src="../assets/images/img_thpt/1.banner.png" alt=""></div></th>
            <th><div class="table_thpt_item">
                <img src="../assets/images/img_thpt/1.1.png" alt="">
                    <p> Giáo Viên: Nguyễn Việt Anh</p>
                    <p1>154 Bài giảng</p1>
                    <p1>5820 câu hỏi</p1>
