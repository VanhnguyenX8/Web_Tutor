...
<body>
	...
	<div class="container_border_banner">
		...
		<div class="stack banner_img"
			style="background-color: #b2b2b2; overflow: hidden;">
			<img src="../assets/images/clone_banner.png" alt="">
		</div>
		<div class="stack banner_img_bottom"
			style="background-color: #b2b2b2; overflow: hidden;">
			...
			<div class="content-top">
				...
				<div class="footer-block">
					...
					<a href=""><img class="footer-img-app"
						...
						class="footer-img-app" src="../assets/images/footer-store-app.png"></a>
					<a href=""><img class="footer-img-app"
						src="../assets/images/congthuong.png"></a>
				</div>
			</div>
		</div>
		<div class="wrapper-ft">
