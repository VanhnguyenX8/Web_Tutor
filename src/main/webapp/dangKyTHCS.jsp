...
<body>
	...
	<div id="main">
		<div class="nhomNut">
		 	...
		 	<button class="nutBacHoc">THCS</button>
		  	<button class="nutBacHoc" onclick="redirectToPage('dangKyTHPT.jsp')">THPT</button>
		  	
		</div>
		<div class="trai">
			<h3 id="bacHoc">Trung học cơ sở</h3>
			<div class="nhomNut">
	...
	<div id="dangKyThanhCong">
		  <p>Bạn đã đăng ký lớp học thành công</p>
		  <button id="nutOK">OK</button>
	</div>
	<div id="footer"></div>
